...
if("TRUE" STREQUAL "TRUE")
  set(plotjuggler_SOURCE_PREFIX /home/fatima/Firmware/src/PlotJuggler)
  set(plotjuggler_DEVEL_PREFIX /home/fatima/Firmware/devel/.private/plotjuggler)
  ...
  set(plotjuggler_INSTALL_PREFIX /home/fatima/Firmware/install)
...
if(NOT "/home/fatima/Firmware/src/PlotJuggler/include " STREQUAL " ")
  set(plotjuggler_INCLUDE_DIRS "")
  set(_include_dirs "/home/fatima/Firmware/src/PlotJuggler/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plotjuggler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fatima/Firmware/src/PlotJuggler/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fatima/Firmware/devel/.private/plotjuggler/lib;/home/fatima/Firmware/devel/lib;/opt/ros/melodic/lib)
...
set(depends "rosbag;rosbag_storage;roscpp;roscpp_serialization;ros_type_introspection;rostime;topic_tools;tf;diagnostic_msgs;nav_msgs")
